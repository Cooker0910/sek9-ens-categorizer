...
const customUpload = async ({ onError, onSuccess, file }) => {
	...
	try {
		const imageUrl = await FirebaseService.uploadFile(fileName + '.' + ext, file, metadata);
	...
	<Row gutter={16}>
		<Col xs={24} sm={24} md={17}>
			<Card title="Basic Info">
				...
				<Form.Item name="shortName" label="Short Name" rules={rules.shortName}>
			...
			<Card title="Pricing">
				<Row gutter={16}>
					<Col xs={24} sm={24} md={12}>
						<Form.Item name="floorprice_decimal" label="Price" rules={rules.floorprice_decimal}>
						<InputNumber
							className="w-100"
		...
		<Col xs={24} sm={24} md={7}>
			...
			<Card title="Organization">
				...
				<Form.Item name="communityDiscord" label="Community Discord" rules={rules.communityDiscord}>
					<Input placeholder="Community Discord" />
				</Form.Item>
				<Form.Item name="communityTwitter" label="Community Twitter" rules={rules.communityTwitter}>
