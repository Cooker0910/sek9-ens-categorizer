import {
  auth, googleAuthProvider, facebookAuthProvider, db, storage } from 'auth/FirebaseAuth';
...
FirebaseService.signUpEmailRequest = async (email, password) =>
	await createUserWithEmailAndPassword(email, password).then(user => user).catch(err => err);	
